    ...
    <ul className="contactList col16">
      <li className="contactItem">
        <a href="mailto:bastien.cailhol@gmail.com">
          <Icon
            path={
              `M12,13L2,6.76V6C2,4.89 2.89,4 4,4H20A2,2 0 0,1 22,6V6.75L12,13M22,18A2,2 0 0,1 20,20H4C2.89,20 2,19.1 2,18V9.11L4,10.36V18H20V10.36L22,9.11V18Z`
            }
            size="4em"
          />
        </a>
      ...
      <li className="contactItem">
        <a href="https://www.linkedin.com/in/BastienCailhol/" target="_blank">
          <Icon
            path={
              `M21,21H17V14.25C17,13.19 15.81,12.31 14.75,12.31C13.69,12.31 13,13.19 13,14.25V21H9V9H13V11C13.66,9.93 
      ...
      <li className="contactItem">
        <a href="https://github.com/Fenryl" target="_blank">
          <Icon
            path={
              `M20.38,8.53C20.54,8.13 21.06,6.54 20.21,4.39C20.21,4.39 18.9,4 15.91,6C14.66,5.67 13.33,5.62 
      ...
      <li className="contactItem">
        <a href="https://twitter.com/BastienCailhol" target="_blank">
          <Icon
            path={
              `M22.46,6C21.69,6.35 20.86,6.58 20,6.69C20.88,6.16 21.56,5.32 21.88,4.31C21.05,4.81 

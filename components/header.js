  ...
  render() {
    ...
    return (
      <div className="header">
        <nav className="menu">
          <ul>
            <li className={focus == "home" ? "focus" : ""}><Link href='/index'>
              <a>
                ...
                size="1em"/>
                <span className="menuItem" className="menuItem">Home</span>
              </a>
            </Link></li>
            <li className={focus == "dev" ? "focus" : ""}><Link href='/dev'>
              <a>
                ...
                size="1.3em"/>
                <span className="menuItem">Dev</span>
              </a>
            </Link></li>
            <li className={focus == "2d" ? "focus" : ""}><Link href='/2d'>
              <a>
                ...
                size="1em"/>
                <span className="menuItem">2D</span>
              </a></Link></li>
            <li className={focus == "3d" ? "focus" : ""}><Link href='/3d'>
              <a>
                ...
                size="1em"/>
                <span className="menuItem">3D</span>
              </a>
            </Link></li>
